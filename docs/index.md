...
<section class="band" id="guides"><div class="container">
  <h2>Free guides</h2>
  <p class="intro">Research summaries and reference material, free to read. No email required.</p>
  <div class="inside">
    <div><p class="sec">Guide</p><h3><a href="https://fieldnotesops.com/guides/lead-routing-sla-benchmarks/">Lead routing and SLA benchmarks: what the data actually shows</a></h3><p>What the Oldroyd response-time research found, how vendor blogs have distorted it, where SLAs break in practice, and a defensible starting SLA.</p></div>
  </div>
</div></section>
